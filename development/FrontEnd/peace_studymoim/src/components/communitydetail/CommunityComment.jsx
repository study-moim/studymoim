...
export default function CommunityComment() {
  ...
  return (
    <>
      <div className="flex flex-col border justify-end items-end w-9/12">
        <div className="w-full">
          ...
          <div className="flex flex-row justify-between">
            <div className="flex justify-start items-end relative gap-px">
              ...
              />
              <div className="px-2.5 py-2 text-[15px] font-bold text-center text-black">
                튜슬리스
              </div>
              <div className="px-2.5 py-[8.5px] text-[15px] text-center text-[#7b7474]">
                2023.01.23 18:00
              </div>
              <div className="px-2.5 py-2 text-[15px] font-bold text-center text-[#898989]">
                조회수 16
              </div>
              <div className="px-2.5 py-[8.5px] text-[15px] font-bold text-center text-[#898989]">
                댓글 1
              </div>
            </div>
        ...
        >
          {!moreToggle ? "답글 보기" : "올리기"}
        </button>
        <div className="w-full flex flex-col items-center ">
          {moreToggle ? <CommunityInnerCommentForm /> : null}
          {moreToggle ? <CommunityInnerComment /> : null}
        </div>
      </div>
    </>
  );
