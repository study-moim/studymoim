                ...
                <div className="flex flex-col justify-end items-end self-stretch flex-grow-0 flex-shrink-0 pl-10">
                    <div className="flex justify-start items-start self-stretch flex-grow-0 flex-shrink-0 gap-4 px-4">
                      ...
                      <span className="flex-grow w-[360px] text-sm font-bold text-left text-[#7b61ff]">
                        ...
                        {props.alarm.url.contains('/community/free') ? (
                            <div className="flex justify-start items-center flex-grow relative gap-2.5" onClick={navigate(props.alarm.url)}>
                                <p className="flex-grow w-[360px] text-sm text-left">
                      <span className="flex-grow w-[360px] text-sm font-bold text-left text-[#7b61ff]">
                        독기가득독준
                      </span>
                        ...
                        {props.alarm.url != '가입요청' && props.alarm.url != '팔로우' && props.alarm.url != '쪽지' && !props.alarm.url.contains('/community/free') ? (
                            <div className="flex justify-start items-center flex-grow relative gap-2.5">
