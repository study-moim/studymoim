    ...
    <div className="w-[336px]">
      <div className="w-full flex flex-col justify-center items-center gap-4">
        ...
        {!followCheck ? (
          ...
          <button onClick={() => followFunction("DELETE")} className="w-full rounded-[20px] bg-[#b1b2ff] text-base font-bold text-center text-white py-2 px-6 hover:bg-[#989aff]">
            팔로우 취소
          </button>
        )}
        {/* TODO: 누르면 어디로 이동? 아니면 다른 기능? */}
        <button className="w-full rounded-[20px] bg-[#b1b2ff] text-base font-bold text-center text-white py-2 px-6 hover:bg-[#989aff]">
          쪽지 보내기
        </button>
      </div>
