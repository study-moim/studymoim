export default function LectureProgress() {
  return (
    <>
      <div className="flex flex-col justify-center items-start w-full h-1/2 relative overflow-hidden gap-5 p-[3px] bg-[#ebefff]">
        <div className="flex justify-start items-start w-full gap-5 px-5">
          ...
          <div className="flex flex-col w-1/2 justify-start items-center flex-grow relative gap-[10px]">
            <img
              ...
              className="flex-grow-0 flex-shrink-0 w-1/2 h-1/2 object-cover"
            />
            <p className="self-stretch flex-grow w-full text-xl text-center text-black">
              [기초강좌] 피그마기초이론
            </p>
            <p className="self-stretch flex-grow w-full text-xl text-center text-black">
              피그마 프로그램의 기초강좌입니다. 프로토타입 대세인 피그마를
              배워봅시다!
            </p>
            <div
          ...
          <div className="flex-grow-0 flex-shrink-0 w-1/2 relative">
            ...
            <div className="w-full h-[31px] absolute left-0 top-[51px]">
              <div className="w-full h-[31px] absolute left-[0.19px] top-[-1px] rounded-full bg-[#bebebe]/[0.22]" />
              <div className="w-1/2 h-[31px] absolute left-[-1px] top-[-0.5px] rounded-full bg-[#1abcfe]" />
            </div>

            <div className="flex flex-col w-full justify-start items-start absolute left-0 top-[109px] gap-2.5 px-[23px] pt-4 pb-[33px] rounded-[5px] bg-white">
              <div className="flex-grow-0 flex-shrink-0 w-full h-[65px] relative">
                ...
                <div className="w-full h-[31px] absolute left-0 top-[34px]">
                  <div className="w-full h-[31px] absolute left-[0.11px] top-[-1px] rounded-full bg-[#bebebe]/[0.22]" />
                  <div className="w-3/4 h-[31px] absolute left-[-1px] top-[-0.5px] rounded-full bg-[#f78e8e]/[0.65]" />
                </div>
              </div>

              <div className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 gap-2.5">
                <div className="flex justify-center items-center flex-grow-0 flex-shrink-0 w-full relative gap-[19px]">
              ...
              <div className="flex-grow-0 flex-shrink-0 w-full h-[31px] relative">
                <div className="w-full h-[31px] absolute left-[0.11px] top-[-1px] rounded-full bg-[#bebebe]/[0.22]" />
                <div className="w-1/5 h-[31px] absolute left-[-1px] top-[-0.5px] rounded-full bg-[#f78e8e]/[0.65]" />
              </div>
              ...
              <div className="flex-grow-0 flex-shrink-0 w-full h-[31px] relative">
                <div className="w-full h-[31px] absolute left-[0.11px] top-[-1px] rounded-full bg-[#bebebe]/[0.22]" />
                <div className="w-full h-[31px] absolute left-[-1px] top-[-0.5px] rounded-full bg-[#f78e8e]/[0.65]" />
              </div>
              ...
              <div className="flex-grow-0 flex-shrink-0 w-full h-[31px] relative">
                <div className="w-full h-[31px] absolute left-[0.11px] top-[-1px] rounded-full bg-[#bebebe]/[0.22]" />
                <div className="w-3/5 h-[31px] absolute left-[-1px] top-[-0.5px] rounded-full bg-[#f78e8e]/[0.65]" />
              </div>
            </div>
          </div>
        </div>
